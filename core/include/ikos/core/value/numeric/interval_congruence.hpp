...
/// \brief Interval-Congruence abstract value on floating point
///
/// The congruence domain on rationals is just a wrapper of the constant domain.
/// We instead implement this as the interval domain alone.
template <>
...
public:
  ...
  explicit IntervalCongruence(float n) : _i(n) {}

  explicit IntervalCongruence(double n) : _i(n) {}
...
}; // end class IntervalCongruence< FNumber >
